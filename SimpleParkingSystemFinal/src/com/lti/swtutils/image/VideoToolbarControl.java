...
public class VideoToolbarControl extends Composite {
	...
	public static final int ALL = PLAY | PAUSE | FAST_FORWARD | REWIND | SEEK_BEGINNING | SEEK_END | SNAP | LIVE | LOOP
			| STOP | PTZ;
	public static final int[] ALL_LIST = new int[] { PLAY, PAUSE, FAST_FORWARD, REWIND, SEEK_BEGINNING, SEEK_END, SNAP,
			LIVE, LOOP, STOP, PTZ };
	...
	public VideoToolbarControl(Composite parent, int style, int videoToolbarStyle) {
		...
		if (hasStyle(SEEK_BEGINNING)) {
			...
			buttonSeekBeginning.setImage(ResourceManager.getImage(VideoToolbarControl.class,
					"resources/control_seek_beginning_blue.png"));
			SWTUtils.setDisabledImage(buttonSeekBeginning,
					ResourceManager.getImage(VideoToolbarControl.class, "resources/control_seek_beginning.png"));
			buttonSeekBeginning.addSelectionListener(new ExceptionSafeSelectionAdapter(getShell(), logger,
		...
		if (hasStyle(REWIND)) {
			...
			buttonRewind.setImage(ResourceManager.getImage(VideoToolbarControl.class,
					"resources/control_rewind_blue.png"));
			SWTUtils.setDisabledImage(buttonRewind,
					ResourceManager.getImage(VideoToolbarControl.class, "resources/control_rewind.png"));
			buttonRewind.addSelectionListener(new ExceptionSafeSelectionAdapter(getShell(), logger,
					new SelectionAdapter() {
						@Override
						public void widgetSelected(SelectionEvent e) {
							if (listener != null)
		...
		if (hasStyle(STOP)) {
			...
			SWTUtils.setDisabledImage(buttonStop,
					ResourceManager.getImage(VideoToolbarControl.class, "resources/control_stop.png"));
			buttonStop.addSelectionListener(new ExceptionSafeSelectionAdapter(getShell(), logger,
					new SelectionAdapter() {
						@Override
						public void widgetSelected(SelectionEvent e) {
							if (listener != null)
		...
		if (hasStyle(PAUSE)) {
			...
			buttonPause.setImage(ResourceManager
					.getImage(VideoToolbarControl.class, "resources/control_pause_blue.png"));
			SWTUtils.setDisabledImage(buttonPause,
					ResourceManager.getImage(VideoToolbarControl.class, "resources/control_pause.png"));
			buttonPause.addSelectionListener(new ExceptionSafeSelectionAdapter(getShell(), logger,
					new SelectionAdapter() {
						@Override
						public void widgetSelected(SelectionEvent e) {
							if (listener != null)
		...
		if (hasStyle(PLAY)) {
			...
			SWTUtils.setDisabledImage(buttonPlay,
					ResourceManager.getImage(VideoToolbarControl.class, "resources/control_play.png"));
			buttonPlay.addSelectionListener(new ExceptionSafeSelectionAdapter(getShell(), logger,
					new SelectionAdapter() {
						@Override
						public void widgetSelected(SelectionEvent e) {
							if (listener != null)
		...
		if (hasStyle(FAST_FORWARD)) {
			...
			buttonFastForward.setImage(ResourceManager.getImage(VideoToolbarControl.class,
					"resources/control_fastforward_blue.png"));
			SWTUtils.setDisabledImage(buttonFastForward,
					ResourceManager.getImage(VideoToolbarControl.class, "resources/control_fastforward.png"));
			buttonFastForward.addSelectionListener(new ExceptionSafeSelectionAdapter(getShell(), logger,
					new SelectionAdapter() {
						@Override
						public void widgetSelected(SelectionEvent e) {
							if (listener != null)
		...
		if (hasStyle(SEEK_END)) {
			...
			buttonSeekEnd.setImage(ResourceManager.getImage(VideoToolbarControl.class,
					"resources/control_seek_end_blue.png"));
			SWTUtils.setDisabledImage(buttonSeekEnd,
					ResourceManager.getImage(VideoToolbarControl.class, "resources/control_seek_end.png"));
			buttonSeekEnd.addSelectionListener(new ExceptionSafeSelectionAdapter(getShell(), logger,
					new SelectionAdapter() {
						@Override
						public void widgetSelected(SelectionEvent e) {
							if (listener != null)
		...
		if (hasStyle(LOOP)) {
			...
			buttonLoop.setImage(ResourceManager
					.getImage(VideoToolbarControl.class, "resources/control_repeat_blue.png"));
			SWTUtils.setDisabledImage(buttonLoop,
					ResourceManager.getImage(VideoToolbarControl.class, "resources/control_repeat.png"));
			buttonLoop.addSelectionListener(new ExceptionSafeSelectionAdapter(getShell(), logger,
					new SelectionAdapter() {
						@Override
						public void widgetSelected(SelectionEvent e) {
							if (listener != null)
		...
		if (hasStyle(LIVE)) {
			...
			buttonLive.addSelectionListener(new ExceptionSafeSelectionAdapter(getShell(), logger,
					new SelectionAdapter() {
						@Override
						public void widgetSelected(SelectionEvent e) {
							if (listener != null)
		...
		if (hasStyle(SNAP)) {
			...
			buttonSnap.addSelectionListener(new ExceptionSafeSelectionAdapter(getShell(), logger,
					new SelectionAdapter() {
						@Override
						public void widgetSelected(SelectionEvent e) {
							if (listener != null)
		...
		if (hasStyle(PTZ)) {
			...
			buttonPtz.addSelectionListener(new ExceptionSafeSelectionAdapter(getShell(), logger,
					new SelectionAdapter() {
						@Override
						public void widgetSelected(SelectionEvent e) {
							if (listener != null)
