...
//		setImage((Image) null);
	...
	private SynchronizedBoolean frameRunnablePending = new SynchronizedBoolean(false); // used to prevent lots of
																						// stacked up async execs of the
																						// frameRunnable.
	...
	protected void postFrame(FrameT frame) {
		...
		// logger.debug("onNewImage image: format=" + image.getFormat() + " width=" + image.getWidth() + " height=" +
		// image.getHeight() + " size=" + image.getBytes().length);
