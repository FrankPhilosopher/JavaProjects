...
//		return "";
	...
	public static void showYesNoCancelQuestion(Shell shell, String message, String caption,
			MessageBoxResultListener listener) {
		if (caption == null)
			caption = getMessageBoxCaptionFor(shell);
		show(shell, message, caption, SWT.YES | SWT.NO | SWT.CANCEL | SWT.ICON_QUESTION, listener);
	}
	...
	public static void showYesNoCancelWarning(Shell shell, String message, String caption,
			MessageBoxResultListener listener) {
		if (caption == null)
			caption = getMessageBoxCaptionFor(shell);
		show(shell, message, caption, SWT.YES | SWT.NO | SWT.CANCEL | SWT.ICON_WARNING, listener);
	...
	public static void showOKCancelWarning(Shell shell, String message, String caption,
			MessageBoxResultListener listener) {
		if (caption == null)
			caption = getMessageBoxCaptionFor(shell);
		show(shell, message, caption, SWT.OK | SWT.CANCEL | SWT.ICON_WARNING, listener);
