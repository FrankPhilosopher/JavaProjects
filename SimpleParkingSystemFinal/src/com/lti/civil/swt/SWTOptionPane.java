...
public class SWTOptionPane extends Composite {
	...
	public static Object showInputDialog(Shell parent, Object message, String title, int messageType, Object icon, // not
																													// used
...
//                messageType, null, selectionValues, initialSelectionValue);
	...
	private static final int[] styles = new int[] { SWT.ICON_ERROR, SWT.ICON_INFORMATION, SWT.ICON_QUESTION,
