 ...
 * The example shown here is generated by the <code>ClusteredXYBarRendererDemo1.java</code> program included in the
...
public class ClusteredXYBarRenderer extends XYBarRenderer implements Cloneable, PublicCloneable, Serializable {
	 ...
	 *            if true, bars will be centered on the
	...
	/**
	 * Tests this renderer for equality with an arbitrary object, returning <code>true</code> if <code>obj</code> is a
