...
import com.rcp.wbw.demo.editor.SWTChartEditor;
import com.rcp.wbw.demo.swt.SWTGraphics2D;
import com.rcp.wbw.demo.swt.SWTUtils;
...
public class ChartComposite extends Composite implements ChartChangeListener, ChartProgressListener, PaintListener,
	...
	public ChartComposite(Composite comp, int style, JFreeChart chart) {
		this(comp, style, chart, DEFAULT_WIDTH, DEFAULT_HEIGHT, DEFAULT_MINIMUM_DRAW_WIDTH,
				DEFAULT_MINIMUM_DRAW_HEIGHT, DEFAULT_MAXIMUM_DRAW_WIDTH, DEFAULT_MAXIMUM_DRAW_HEIGHT,
	...
	public ChartComposite(Composite comp, int style, JFreeChart chart, boolean useBuffer) {
		...
		this(comp, style, chart, DEFAULT_WIDTH, DEFAULT_HEIGHT, DEFAULT_MINIMUM_DRAW_WIDTH,
				DEFAULT_MINIMUM_DRAW_HEIGHT, DEFAULT_MAXIMUM_DRAW_WIDTH, DEFAULT_MAXIMUM_DRAW_HEIGHT, useBuffer, true, // properties
				true, // save
				true, // print
				true, // zoom
				true // tooltips
	...
	public void zoomInDomain(double x, double y) {
		...
		if (p instanceof Zoomable) {
			...
			plot.zoomDomainAxes(this.zoomInFactor, this.info.getPlotInfo(), translateScreenToJava2D(new Point((int) x,
					(int) y)));
		}
	}
	...
	public void zoomInRange(double x, double y) {
		...
		if (p instanceof Zoomable) {
			...
			z.zoomRangeAxes(this.zoomInFactor, this.info.getPlotInfo(), translateScreenToJava2D(new Point((int) x,
					(int) y)));
		}
	}
	...
	public void zoomOutDomain(double x, double y) {
		...
		if (p instanceof Zoomable) {
			Zoomable z = (Zoomable) p;
			z.zoomDomainAxes(this.zoomOutFactor, this.info.getPlotInfo(), translateScreenToJava2D(new Point((int) x,
					(int) y)));
		}
	}
	...
	public void zoomOutRange(double x, double y) {
		...
		if (p instanceof Zoomable) {
			Zoomable z = (Zoomable) p;
			z.zoomRangeAxes(this.zoomOutFactor, this.info.getPlotInfo(), translateScreenToJava2D(new Point((int) x,
					(int) y)));
		}
	}
	...
	public void mouseMove(MouseEvent event) {
		...
		if (this.zoomPoint != null) {
			...
			if (hZoom && vZoom) {
				...
				this.zoomRectangle = new Rectangle(scaledDataArea.x, this.zoomPoint.y, scaledDataArea.width, ymax
						- this.zoomPoint.y);
			}
			this.canvas.redraw();
		}
