...
public class SWTGraphics2D extends Graphics2D {
	...
	/**
	 * Returns the current value for the specified hint key, or <code>null</code> if no value is set.
	 * 
	 * @param hintKey
	 ...
	 * context only supports instances of {@link Color} or {@link GradientPaint} (in the latter case there is no real
	 * gradient
	 * support, the paint used is the <code>Color</code> returned by <code>getColor1()</code>).
	 * 
	 * @param paint
	 ...
	 * The <code>fillRectangle</code> method of the <code>GC</code> class uses the background color so we must switch
	 * colors.
	 * 
	...
	/**
	 * Not implemented - see {@link Graphics2D#drawImage(Image, AffineTransform, ImageObserver)}.
	 * 
	 * @param image
	 *            the image.
	 * @param xform
	...
	/**
	 * Not implemented - see {@link Graphics2D#drawRenderedImage(RenderedImage, AffineTransform)}.
	 * 
	 * @param image
	 *            the image.
	 * @param xform
	...
	/**
	 * Not implemented - see {@link Graphics2D#drawRenderableImage(RenderableImage, AffineTransform)}.
	 * 
	 * @param image
	 *            the image.
	 * @param xform
	...
	/**
	 * Not implemented - see {@link Graphics#drawImage(Image, int, int, int, int, int, int, int, int, ImageObserver)}.
	 * 
	 * @param image
	 *            the image.
	 * @param dx1
	 ...
	 * instead of creating a new one. This is used in {@link #setFont()} for instance.
	 * 
	 * @param font
	...
	private org.eclipse.swt.graphics.Font getSwtFontFromPool(Font font) {
		...
		if (swtFont == null) {
			swtFont = new org.eclipse.swt.graphics.Font(this.gc.getDevice(), SWTUtils.toSwtFontData(
					this.gc.getDevice(), font, true));
	 ...
	 * instance is already in the pool, it will be used
	 * instead of creating a new one. This is used in {@link #setColor()} for instance.
	 * 
	 * @param awtColor
	 ...
	 * instance is already in the pool, it will be used
	 * instead of creating a new one. This is used in {@link #setTransform()} for instance.
	 * 
	 * @param awtTransform
