...
package com.rcp.wbw.demo.editor;
...
import com.rcp.wbw.demo.swt.SWTPaintCanvas;
...
class SWTPlotAppearanceEditor extends Composite {
	...
	SWTPlotAppearanceEditor(Composite parent, int style, Plot plot) {
		...
		this.outlinePaintCanvas = new SWTPaintCanvas(general, SWT.NONE, SWTUtils.toSwtColor(getDisplay(),
		...
		this.backgroundPaintCanvas = new SWTPaintCanvas(general, SWT.NONE, SWTUtils.toSwtColor(getDisplay(),
