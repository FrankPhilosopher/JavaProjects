...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<div class="container_top">
			...
			你当前的位置：[系统用户>集团用户管理>分组用户管理>终端用户管理 > 新增终端用户]
		</div>
		<form method="post" action="Admin_saveTerminal" id="form1"
			name="basicInfoForm">
			<div class="content">
				<ul class="newobj">
					<li>
				...
				<div class="cont90">
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0"
						...
						<tr>
							...
							<td>
								<input id="simid" type="text" size="50" name="terminal.sim"
									maxlength="20" value="<s:property value="terminal.sim"/>" />
							</td>
						</tr>
						<tr>
							<th scope="row">
						...
						<tr>
							...
							<td>
								<input id="cellphone" type="text" size="50"
									name="terminal.carnumber" maxlength="20"
									value="<s:property value="terminal.carnumber"/>" />
							</td>
						</tr>
						<tr>
							<th scope="row">
						...
						<tr>
							...
							<td>
								<input id="model" type="text" size="50" name="terminal.model"
									maxlength="10" value="<s:property value="terminal.model"/>" />
							</td>
						</tr>
						<tr>
							<th scope="row">
