...
function delConfirm() {
	...
	<body>
		<div class="container_top">
			...
			你当前的位置：[系统管理 > 集团用户管理>分组用户管理>终端用户管理]
		</div>
		<div class="content">
           ...
           bgcolor="#ffffff"
			...
			<form action="Admin_terminalManager" method="post" name="pageForm">
				<div class="tablefoot">
					<table border="0" align="right" cellpadding="0" cellspacing="0"
						...
						<tr>
							<td width="40">
								<a
									href="<s:url action="Admin_terminalManager"><s:param name="pageIndex" value="1"/></s:url>"><img
										src="<%=path%>/images/first.gif" /> </a>
							</td>
							<td width="45">
								<a
									href="<s:url action="Admin_terminalManager"><s:param name="pageIndex" value="pageIndex-1"/></s:url>"><img
							...
							<td width="40">
								<a
									href="<s:url action="Admin_terminalManager"><s:param name="pageIndex" value="pages"/></s:url>"><img
