...
function validateMobile(input) {
	...
	<body>
		<div class="container_top">
			...
			你当前的位置：[分组机构管理>终端用户管理 > 编辑终端用户]
		</div>
		<form method="post" action="YunWei_updateTerminal" id="form1"
			name="basicInfoForm">
			<div class="content">
				<ul class="newobj">
					<li>
						...
						<tr>
							...
							<td>
								<input id="model" type="text" size="50"
									name="terminal.model" maxlength="20"
									value="<s:property value="terminal.model"/>" />
							</td>
						</tr>
						<tr>
							<th scope="row">
						...
						<tr>
							...
							<td>
								<input id="p1" type="text" size="50"
									name="terminal.privilege1" maxlength="20"
						...
						<tr>
							...
							<td>
								<input id="p2" type="text" size="50"
									name="terminal.privilege2" maxlength="20"
						...
						<tr>
							...
							<td>
								<input id="p3" type="text" size="50"
									name="terminal.privilege3" maxlength="20"
