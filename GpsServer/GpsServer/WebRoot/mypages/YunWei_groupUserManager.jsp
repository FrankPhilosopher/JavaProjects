...
<body>
	<div class="container_top"><span class="c_t_l"></span><span class="c_t_r"></span><img src="<%=path%>/images/tb.gif" width="16" height="16" />你当前的位置：[系统管理 > 分组用户管理> 账号管理]</div>
		<div class="content">
		  <div class="tool"> 
			<form action="YunWei_groupUserSearch" method="post" name="searchForm">
			   	<table border="0" >
				  <tr>
				    <td> 账号名称：</td>
				    ...
				    <td><a href="#" onclick="submitSearchForm(searchForm)" class="cssbtn"><img src="<%=path%>/images/search.gif"/>查询</a></td>
				  	<td><a href='<s:url action="YunWei_beforeAddGroupUser"></s:url>' class="cssbtn"><img src="<%=path%>/images/adduser.png"/>新增账号</a></td>
				  </tr>
				</table>
			</form>
		  </div>
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="datatable" style="text-align:center;">
	  <tr>
	    ...
	    <th scope="col">断油断电权限</th>
	    <th scope="col">修改信息权限</th>
	    <th scope="col">导出数据权限</th>
	  ...
	  <tr
       ...
       >
	    ...
	    <td><img src="<%=path%>/images/edt.gif" width="16" height="16" /><a href='<s:url action="YunWei_editGroupUserInfo"><s:param name="groupUserId" value="#groupUser.id"/></s:url>'>编辑</a>&nbsp; &nbsp;<img src="<%=path%>/images/del.gif" width="16" height="16" /><a href='<s:url action="YunWei_deleteGroupUser"><s:param name="groupUserId" value="#groupUser.id"/></s:url>' onclick="return delConfirm()">删除</a>&nbsp; &nbsp;</td>
	  </tr>
	  </s:iterator>
	</table>
	
	<form action="YunWei_findGroupUserList" method="post" name="pageForm">
		<div class="tablefoot">
					<table border="0" align="right" cellpadding="0" cellspacing="0" class="right">
		                <tr>
		                  <td width="40"><a href="<s:url action="YunWei_findGroupUserList"><s:param name="pageIndex" value="1"/></s:url>"><img src="<%=path%>/images/first.gif"/></a></td>
		                  <td width="45"><a href="<s:url action="YunWei_findGroupUserList"><s:param name="pageIndex" value="pageIndex-1"/></s:url>"><img src="<%=path%>/images/back.gif"/></a></td>
		                  <td width="45"><a href="<s:url action="YunWei_findGroupUserList"><s:param name="pageIndex" value="pageIndex+1"/></s:url>"><img src="<%=path%>/images/next.gif"/></a></td>
		                  <td width="40"><a href="<s:url action="YunWei_findGroupUserList"><s:param name="pageIndex" value="pages"/></s:url>"><img class="btnImg" src="<%=path%>/images/last.gif"/></a></td>
		                  <td width="100"><div align="center"><span class="STYLE1">转到第
		                    <input name="pageIndex" type="text" size="4" maxlength="4" style="height:12px; width:20px; border:1px solid #999999;" /> 
		                    	页 </span></div></td>
		                  <td width="40">
		                  	<a href="#" ><img src="images/go.gif" width="37" height="15"/></a>
		                  </td><!-- 不跳转，使其失效 -->
		                </tr>
		            </table>
