...
function delConfirm() {
	...
	<body>
		<div class="container_top">
			...
			你当前的位置：[系统管理 > 集团用户管理>分组用户管理>终端用户管理>搜索结果]
		</div>
		<div class="content">
			<form action="Admin_terminalSearch?pageIndex=1" method="post"
				name="searchForm">
				<div class="tool">
					<table border="0">
						<tr>
							...
							<td>
								<a href="Admin_addTerminal" class="cssbtn"> <img
										src="<%=path%>/images/add.gif" />新增终端用户</a>
							</td>
						</tr>
					</table>
				</div>
           ...
           bgcolor="#ffffff"
						...
						<td>
							...
							<s:if test="#session.user.modify == 1">
								<img src="<%=path%>/images/edt.gif" width="16" height="16" />
								<a
									href='<s:url action="Admin_editTerminal"><s:param name="sim" value="#terminal.sim"/></s:url>'>编辑</a>
								<img src="<%=path%>/images/edt.gif" width="16" height="16" />
								<a
									href='<s:url action="Admin_changeTerminal"><s:param name="sim" value="#terminal.sim"/></s:url>'>转移终端</a>
								<img src="<%=path%>/images/del.gif" width="16" height="16" />
								<a
									href='<s:url action="Admin_deleteTerminal"><s:param name="sim" value="#terminal.sim"/></s:url>'
			...
			<form action="Admin_terminalSearch" method="post" name="pageForm">
				<div class="tablefoot">
					<table border="0" align="right" cellpadding="0" cellspacing="0"
						...
						<tr>
							<td width="40">
								<a
									href="<s:url action="Admin_terminalSearch"><s:param name="pageIndex" value="1"/></s:url>"><img
										src="<%=path%>/images/first.gif" /> </a>
							</td>
							<td width="45">
								<a
									href="<s:url action="Admin_terminalSearch"><s:param name="pageIndex" value="pageIndex-1"/></s:url>"><img
							...
							<td width="40">
								<a
									href="<s:url action="Admin_terminalSearch"><s:param name="pageIndex" value="pages"/></s:url>"><img
