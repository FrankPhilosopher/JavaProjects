...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
			...
			function checkForm(form) {
				if(!validateString(document.getElementById("userid").value)){
					document.getElementById("formMessage").innerHTML = "账户名只能包含数字和字母！";
					return;
				}
	...
	<body>
		<div class="container_top">
			...
			你当前的位置：[系统管理 > 分组用户管理> 账户管理> 新建账户]
		</div>
		<form method="post" action="JiTuan_addGroupUser" id="infoform"
			name="infoform">
			<div class="content">
				<ul class="newobj">
					<li>
				...
				<div class="cont90">
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0"
						...
						<tr>
							...
							<td>
								<input type="text" size="50" id="userid" maxlength="20"
									value="<s:property value="groupUser.userid" />"
									name="groupUser.userid" />
								&nbsp;&nbsp;&nbsp;&nbsp;<label style="color:red;">账户名请不要包含中文</label>
							</td>
						</tr>
						<tr>
							<th scope="row">
							...
							<td>
								<input type="text" size="50" id="username" maxlength="20"
