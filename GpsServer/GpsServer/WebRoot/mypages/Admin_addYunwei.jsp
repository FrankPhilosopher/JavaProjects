...
function validateMobile(input) {
	...
	function checkForm() {
	    if (document.getElementById("orgname").value == null
			...
			return;
		}else if(!validateTel(document.getElementById("telphone").value)){
	...
	<body>
		<div class="container_top">
			...
			你当前的位置：[运维用户管理 > 新增运维机构]
		</div>
		<form method="post" action="Admin_addYunwei" id="form1"
			name="basicInfoForm">
			<div class="content">
				<ul class="newobj">
					<li>
				...
				<div class="cont90">
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0"
						...
						<tr>
							...
							<td>
								<input id="orgname" type="text" size="50" name="yunwei.name"
									maxlength="30" />
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td>
								<input type="text" size="50" name="yunwei.linkman"
									maxlength="20" />
							</td>
						</tr>
						<tr>
				...
				<table border="0" class="btn_table">
					<tr>
						<td>
							...
							<a
								href="<s:url action="Admin_yunweiManager?pageIndex=1"></s:url>"
