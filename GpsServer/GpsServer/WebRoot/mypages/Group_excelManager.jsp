...
<s:head theme="xhtml"/>
	...
	<form action="Group_terminalExcelSearch" method="post" name="searchForm">
		<div class="content">
			<h6>
				搜索条件&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	...
	<form action="Group_excelExport" method="post" name="exportForm">
	...
	<form action="Group_findTerminalExcelList" method="post" name="pageForm">
		<div class="tablefoot">
					<table border="0" align="right" cellpadding="0" cellspacing="0" class="right">
		                <tr>
		                  <td width="40"><a href="<s:url action="Group_findTerminalExcelList"><s:param name="pageIndex" value="1"/></s:url>"><img src="<%=path%>/images/first.gif"/></a></td>
		                  <td width="45"><a href="<s:url action="Group_findTerminalExcelList"><s:param name="pageIndex" value="pageIndex-1"/></s:url>"><img src="<%=path%>/images/back.gif"/></a></td>
		                  <td width="45"><a href="<s:url action="Group_findTerminalExcelList"><s:param name="pageIndex" value="pageIndex+1"/></s:url>"><img src="<%=path%>/images/next.gif"/></a></td>
		                  <td width="40"><a href="<s:url action="Group_findTerminalExcelList"><s:param name="pageIndex" value="pages"/></s:url>"><img class="btnImg" src="<%=path%>/images/last.gif"/></a></td>
