...
<script type="text/javascript" src="<%=path%>/js/jquery-1.7.js">
	...
	function resetForm() {
		...
		//window.close();
		window.location.href="JiTuan_terminalManager";
	}
	...
	function checkForm() {
		//终端号 SIM卡号不能为空
		if(document.getElementById("simid").value == ""){
			document.getElementById("formMessage").innerHTML = "终端号不可以为空!";
			return;
		}
		...
		if(!validateTel(document.getElementById("cp").value)&&!validateMobile(document.getElementById("cp").value)){
	...
	<body>
		<div class="container_top">
			...
			你当前的位置：[分组机构管理>终端用户管理 > 新增终端用户]
		</div>
		<form method="post" action="JiTuan_saveTerminal" id="form1"
			name="basicInfoForm">
			<div class="content">
				<ul class="newobj">
					<li>
				...
				<div class="cont90">
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0"
						...
						<tr>
							...
							<td>
								<input id="simid" type="text" size="50"
									name="terminal.sim" maxlength="20" value="<s:property value="terminal.sim"/>"/>
							</td>
						</tr>
						<tr>
							<th scope="row">
						...
						<tr>
							...
							<td>
								<input id="cellphone" type="text" size="50"
									name="terminal.carnumber" maxlength="20" value="<s:property value="terminal.carnumber"/>"/>
							</td>
						</tr>
						<tr>
							<th scope="row">
							...
							<td>
								<select name="terminal.TCarInfo.carTypeId" id="machineid">
									...
									<s:iterator value="carInfoList" var="car" status="status">
										<option value="<s:property value="#car.carTypeId"/>"
										   <s:if	
										   		test="terminal.TCarInfo.carTypeId==#car.carTypeId">selected</s:if>  >
						...
						<tr>
							...
							<td>
								<input id="gas" type="text" size="50"
									name="terminal.gas" maxlength="20" value="<s:property value="terminal.gas"/>"/>
							</td>
						</tr>
						<tr>
							<th scope="row">
							...
							<td>
								<input id="model" type="text" size="50"
									name="terminal.model" maxlength="10" value="<s:property value="terminal.model"/>"/>
							</td>
						</tr>
						<tr>
							<th scope="row">
							...
							<td>
								<input id="basekilo" type="text" size="50"
									name="terminal.basekilo" maxlength="5" value="<s:property value="terminal.basekilo"/>"/>
							</td>
						</tr>
						<tr>
							<th scope="row">
							...
							<td>
								<input id="maintenance" type="text" size="50"
									name="terminal.maintenance" maxlength="5" value="<s:property value="terminal.maintenance"/>"/>
							</td>
						</tr>
						<tr>
							<th scope="row">
							...
							<td>
								<input id="p1" type="text" size="50"
									name="terminal.privilege1" maxlength="20" value="<s:property value="terminal.privilege1"/>"/>
							</td>
						</tr>
						<tr>
							<th scope="row">
							...
							<td>
								<input id="p2" type="text" size="50"
									name="terminal.privilege2" maxlength="20" value="<s:property value="terminal.privilege2"/>"/>
							</td>
						</tr>
						<tr>
							<th scope="row">
							...
							<td>
								<input id="p3" type="text" size="50"
									name="terminal.privilege3" maxlength="20" value="<s:property value="terminal.privilege3"/>"/>
							</td>
						</tr>
						<tr>
							<th scope="row">
							...
							<td>
								<input id="orgname" type="text" size="50" name="terminal.username"
									maxlength="20" value="<s:property value="terminal.username"/>"/>
							</td>
						</tr>
						<tr>
							<th scope="row">
							...
							<td>
								<input id="cp" type="text" size="50" name="terminal.cellphone"
									maxlength="20" value="<s:property value="terminal.cellphone"/>"/>
							</td>
						</tr>
						<tr>
							<th scope="row">
							...
							<td>
								<input id="prin" type="text" size="50" name="terminal.principal"
									maxlength="20" value="<s:property value="terminal.principal"/>"/>
							</td>
						</tr>
						<tr>
							<td>
