...
<html>
	<head>
		...
		<script type="text/javascript">
			function checkMoney(form) {
				...
				if(isNaN(mon)){
					document.getElementById("formMessage").innerHTML = "充值金额请输入数字";
					return;
				}
				if (mon < 100 || mon > 100000) {
					document.getElementById("formMessage").innerHTML = "请注意充值限额";
					return;
				}
				form.submit();
			}
	...
	<body>
		...
		<div class="content">
			...
			<form action="JiTuan_addGroupExpense" method="post" name="form"
				id="form">
					<div class="b1">
							...
							<tr>
								...
								<td>
									...
									<label style="color: red; margin-left: 10px;">
										[注意：最低限额是 100 RMB，最大限额是 100000 RMB]
									</label>
								</td>
								<td>
