	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="datatable" style="text-align:center;">
	  ...
	  <tr
       ...
       >
	    ...
	    <td><img src="<%=path%>/images/edt.gif" width="16" height="16" /><a href='<s:url action="Group_terminalExpenseAdd"><s:param name="terminalId" value="#terminal.id"/></s:url>'>充值</a>&nbsp; &nbsp;</td>
	  </tr>
	  </s:iterator>
	</table>
