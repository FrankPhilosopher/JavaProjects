...
<script type="text/javascript" src="<%=path%>/js/jquery-1.7.js">
	...
	<body>
		<div class="container_top">
			...
			你当前的位置：[终端用户管理 > 编辑终端用户]
		</div>
		<form method="post" action="Group_updateTerminal" id="form1"
			name="basicInfoForm">
			<div class="content">
				<ul class="newobj">
					<li>
				...
				<div class="cont90">
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0"
						...
						<tr>
							...
							<td>
									<input id="phoneid" type="text" size="50"
									name="terminal.phone" maxlength="20" value="<s:property value="terminal.phone"/>"/>
							</td>
						</tr>
						<tr>
							<th scope="row">
							...
							<td>
								<input id="dasd" type="text" size="50"
							...
							<td>
								<select name="terminal.TCarInfo.carTypeId" id="machineid">
									...
									<s:iterator value="cars" var="car" status="status">
										<option value="<s:property value="#car.carTypeId"/>" <s:if test="#car.carTypeId == terminal.TCarInfo.carTypeId">selected="selected"</s:if>>
						...
						<tr>
							...
							<td>
								<input  type="text" size="50"
									name="terminal.model" maxlength="20" value="<s:property value="terminal.model"/>"/>
							</td>
						</tr>
						<tr>
							<th scope="row">
						...
						<tr>
							...
							<td>
								<input id="cellphone" type="text" size="50" name="terminal.cellphone"
						...
						<tr>
							...
							<td>
								<input id="orgname" type="text" size="50" name="terminal.principal"
