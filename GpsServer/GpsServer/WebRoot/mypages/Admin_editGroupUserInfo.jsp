...
function validateNameAndPwd(input){
	...
	<body>
		<div class="container_top">
			...
			你当前的位置：[系统管理 >集团用户管理> 分组用户管理> 账户管理> 编辑账户]
		</div>
		<form method="post" action="Admin_saveGroupUserInfo" id="infoform"
			name="infoform">
			<div class="content">
				<ul class="newobj">
					<li>
						...
						<tr>
							...
							<td>
								<input type="text" size="50" id="userid"
									...
									name="groupUser.userid" maxlength="20" disabled="disabled" />
							</td>
						</tr>
						<tr>
							<th scope="row">
							...
							<td>
								<input type="text" size="50"
									...
									name="groupUser.name" maxlength="20" />
							</td>
						</tr>
						<tr>
							<th scope="row">
							...
							<td>
								<input type="text" size="50" id="pwd"
									...
									name="groupUser.pwd" maxlength="20" />
							</td>
						</tr>
						<tr>
							<th scope="row">
							...
							<td>
								<input id="cellphone" type="text" size="50"
									...
									name="groupUser.cellphone" maxlength="20" />
							</td>
						</tr>
						<tr>
							<th scope="row">
				...
				<table border="0" class="btn_table">
					<tr>
						<td>
							...
							<a
								href="<s:url action="Admin_groupUserManager?pageIndex=1"></s:url>"
