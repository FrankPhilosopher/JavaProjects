...
function validateMobile(input) {
	...
	<body>
		...
		<form method="post" action="JiTuan_updateTerminal" id="form1"
			name="basicInfoForm">
			<div class="content">
				<ul class="newobj">
					<li>
						...
						<tr>
							...
							<td>
								<select name="terminal.PPeriod">
									<option value="0"
										<s:if test='terminal.PPeriod == 0'>selected="selected"</s:if>>
										关闭定位
									</option>
									<s:bean name="org.apache.struts2.util.Counter" id="counter">
										...
										<s:iterator>
											<option value="<s:property/>"
												<s:if test='terminal.PPeriod == current-1'>selected="selected"</s:if>>
												<s:property />
											</option>
										</s:iterator>
									</s:bean>
