	...
	<body>
		...
		<div class="content">
				...
				<div class="tool">
					<table border="0">
						<tr>
							...
							<td>
								<a href='<s:url action="Admin_forwardAddYunwei"></s:url>'
           ...
           bgcolor="#ffffff"
			...
			<form action="Admin_yunweiSearch" method="post" name="pageForm">
				<div class="tablefoot">
					<table border="0" align="right" cellpadding="0" cellspacing="0"
						...
						<tr>
							<td width="40">
								<a
									href="<s:url action="Admin_yunweiSearch"><s:param name="pageIndex" value="1"/></s:url>"><img
										src="<%=path%>/images/first.gif" /> </a>
							</td>
							<td width="45">
								<a
									href="<s:url action="Admin_yunweiSearch"><s:param name="pageIndex" value="pageIndex-1"/></s:url>"><img
							...
							<td width="40">
								<a
									href="<s:url action="Admin_yunweiSearch"><s:param name="pageIndex" value="pages"/></s:url>"><img
