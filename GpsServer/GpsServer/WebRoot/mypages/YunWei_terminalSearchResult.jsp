...
function delConfirm() {
	...
	<body>
		<div class="container_top">
			...
			你当前的位置：[分组机构管理> 终端管理>搜索结果]
		</div>
		<div class="content">
			<div class="tool">
				<form action="YunWei_terminalSearch?pageIndex=1" method="post" name="searchForm">
					<table border="0">
						<tr>
							<td>
								按：
							...
							<td>
								<a href='<s:url action="YunWei_addTerminal"></s:url>'
           ...
           bgcolor="#ffffff"
						...
						<td>
							...
							<s:if test="#session.user.modify == 1">
								<img src="<%=path%>/images/edt.gif" width="16" height="16" />
								<a
									href='<s:url action="YunWei_editTerminal"><s:param name="sim" value="#terminal.sim"/></s:url>'>编辑</a>&nbsp;
							&nbsp;
							<img src="<%=path%>/images/del.gif" width="16" height="16" />
								<a
									href='<s:url action="YunWei_deleteTerminal"><s:param name="sim" value="#terminal.sim"/></s:url>'
			...
			<form action="YunWei_terminalSearch" method="post" name="pageForm">
				<div class="tablefoot">
					<table border="0" align="right" cellpadding="0" cellspacing="0"
						...
						<tr>
							<td width="40">
								<a
									href="<s:url action="YunWei_terminalSearch"><s:param name="pageIndex" value="1"/></s:url>"><img
										src="<%=path%>/images/first.gif" /> </a>
							</td>
							<td width="45">
								<a
									href="<s:url action="YunWei_terminalSearch"><s:param name="pageIndex" value="pageIndex-1"/></s:url>"><img
							...
							<td width="40">
								<a
									href="<s:url action="YunWei_terminalSearch"><s:param name="pageIndex" value="pages"/></s:url>"><img
