...
function submitSearchForm() {
	if (document.searchForm.orgSearchName.value == ""
			|| (/\s+/g.test(document.searchForm.orgSearchName.value))) {
		window.alert("输入单位名称");
		return;
	}
...
function delConfirm() {
	...
	<body>
		<div class="container_top">
			...
			你当前的位置：[系统管理 > 费用充值>搜索结果]
		</div>
		<div class="content">
			<form action="Admin_expenseJituanSearch" method="post" name="searchForm">
				<div class="tool">
					<table border="0">
						<tr>
							<td>
           ...
           bgcolor="#ffffff"
						...
						<td>
								<s:property value="#jituan.TOrgainzations.size()" />
						</td>
						<td>
						...
						<td>
							<a
								href='<s:url action="Admin_beforeRecharge"><s:param name="orgId" value="#jituan.orgId"/></s:url>'>充值</a>
						</td>
					</tr>
				</s:iterator>
			</table>

			<form action="Admin_expenseJituanSearch" method="post" name="pageForm">
				<div class="tablefoot">
					<table border="0" align="right" cellpadding="0" cellspacing="0"
						...
						<tr>
							<td width="40">
								<a
									href="<s:url action="Admin_expenseJituanSearch"><s:param name="pageIndex" value="1"/></s:url>"><img
										src="<%=path%>/images/first.gif" /> </a>
							</td>
							<td width="45">
								<a
									href="<s:url action="Admin_expenseJituanSearch"><s:param name="pageIndex" value="pageIndex-1"/></s:url>"><img
							...
							<td width="40">
								<a
									href="<s:url action="Admin_expenseJituanSearch"><s:param name="pageIndex" value="pages"/></s:url>"><img
