...
function validateMobile(input) {
	...
	<body>
		<div class="container_top">
			...
			你当前的位置：[系统用户管理 > 编辑集团机构]
		</div>
		<form method="post" action="Admin_saveJituanInfo" id="form1"
			name="editInfoForm">
			<div class="content">
				<ul class="newobj">
					<li>
				...
				<div class="cont90">
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0"
						...
						<tr>
							...
							<td>
								<input id="orgname" type="text" size="50"
									value="<s:property value="jituan.name" />" name="jituan.name"
									maxlength="30" />
							</td>
						</tr>
						<tr>
							...
							<td>
								<input id="telphone" type="text" size="50"
									value="<s:property value="jituan.telephone" />"
						...
						<tr>
							...
							<td>
								<input type="text" size="50"
									value="<s:property value="jituan.linkman" />"
									name="jituan.linkman" maxlength="20" />
							</td>
						</tr>
						<tr>
							<th scope="row">
						...
						<tr>
							...
							<td>
								<input type="text" size="50"
									value="<s:property value="jituan.address" />"
									name="jituan.address" maxlength="30" />
							</td>
						</tr>
						<tr>
							<th scope="row">
				...
				<table border="0" class="btn_table">
					<tr>
						<td>
							...
							<a href="<s:url action="Admin_jituanManager?pageIndex=1"></s:url>"
...
$.ajax( {
	...
	success : function(json) {
		for (i = 0; i < json.cities.length; i++) {
			...
			if (city.areaId != <s:property value="jituan.TArea.areaId" />) {
				$('#selectAreaId').append(
