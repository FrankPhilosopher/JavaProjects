            ...
            <tr>
                <td valign="top" height="99%">
                    <dl class="sidemenu">
                        ...
                        <dd id="submenu1">
                            <a href="JiTuan_basicInfo" target="I2">基本资料</a>
                            <a href="JiTuan_groupManager" target="I2">分组机构管理</a>
                            <a href="JiTuan_logManager" target="I2">日志管理 </a>
                            <s:if test="#session.user.export == 1">
                            <a href="JiTuan_excelManager" target="I2">数据报表管理</a>
                            </s:if>
                        </dd>
                        ...
                        <dd id="submenu2"> <!-- style="display:none;" -->
                            <a href="JiTuan_groupExpenseManager" target="I2">费用充值</a>
                        </dd>
                    </dl>
                </td>
            </tr>
