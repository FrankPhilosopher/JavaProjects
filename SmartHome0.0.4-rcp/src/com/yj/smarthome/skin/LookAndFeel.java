...
public class LookAndFeel {
	...
	private LookAndFeel() {
		...
		if (rcp_settings != null) {
			if (rcp_settings.get(IPreferencePageConstants.SKIN_TYPE) != null
					&& !"".equals(rcp_settings.get(IPreferencePageConstants.SKIN_TYPE)))
	...
	public Image getToolBarImage() {
		if (LookAndFeel.TYPE_BLUE.equals(LookAndFeel.CURRENT_TYPE)) {
			return Activator.getImageDescriptor("icons/bg/content_blue.jpg").createImage();
		} else if (LookAndFeel.TYPE_PURPLE.equals(LookAndFeel.CURRENT_TYPE)) {
			return Activator.getImageDescriptor("icons/bg/toolbar_purple.jpg").createImage();
		} else {
			return Activator.getImageDescriptor("icons/bg/content_blue.jpg").createImage();
		}
	}
	...
	public Image getMenuImage() {
		if (LookAndFeel.TYPE_BLUE.equals(LookAndFeel.CURRENT_TYPE)) {
			return Activator.getImageDescriptor("icons/bg/menu_blue.jpg").createImage();
		} else if (LookAndFeel.TYPE_PURPLE.equals(LookAndFeel.CURRENT_TYPE)) {
			return Activator.getImageDescriptor("icons/bg/menu_purple.jpg").createImage();
		} else {
			return Activator.getImageDescriptor("icons/bg/menu_blue.jpg").createImage();
		}
	}
	...
	public Image getContentBgImage() {
		if (LookAndFeel.TYPE_BLUE.equals(LookAndFeel.CURRENT_TYPE)) {
			...
			return Activator.getImageDescriptor("icons/bg/content_purple.jpg").createImage();
		} else {
			return Activator.getImageDescriptor("icons/bg/content_blue.jpg").createImage();
		}
	}
	...
	public Font getControlFont() {
		...
		if (rcp_settings != null) {
			...
			if (fontname != null && !"".equals(fontname)) {
				...
				return SimpleFontManager.get(fontdata.getName() + "," + fontdata.getStyle() + "," + fontdata.getHeight(),
