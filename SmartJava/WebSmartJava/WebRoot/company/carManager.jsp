...
<body>
    ...
    <ul id="top-navigation">
          ...
          <li class="active"><span><span><a href="<%=path %>/company/carManager.jsp">车辆管理</a></span></span></li>
    ...
    <div id="operator"class="active"><span>省公司&nbsp;&nbsp;<%=loginUser.getName() %></span><a href="<%=path %>/login.jsp">退出</a></div>
		...
		<div id="middle">
			<div id="left-column">
				<h3>车辆管理</h3>
				<ul class="nav">
					<li class="active"><a href="actionCar.jsp?action=forwardAdd"
						target="center-frame">增加车辆</a></li>
					<li><a href="actionCar.jsp?action=forwardDispatch&pageIndex=1" target="center-frame">车辆调度</a>
					</li>
					<li><a href="actionCar.jsp?action=forwardList&pageIndex=1" target="center-frame">车辆列表</a></li>
				</ul>
			</div>
			<div id="center-column">
				<iframe id="frame_content" name="center-frame" src="actionCar.jsp?action=forwardAdd"
