...
<body>
	<div id="main">
		<div id="header">
			...
			<ul id="top-navigation">
				...
				%>
				<li><span><span><a
							href="<%//=path%>/company/userManager.jsp">人员管理</a> </span> </span></li>
				<li><span><span><a
							href="<%//=path%>/company/excelManager.jsp">报表管理</a> </span> </span></li>
				<%
					}
				%>
			</ul>
	...
	<div id="middle">
		<div id="left-column">
			<h3>路线管理</h3>
			<ul class="nav">
				<li><a href="addroute.jsp" target="center-frame">路线添加</a>
				</li>
				<li><a href="actionRoute.jsp?action=front"
					target="center-frame">路线查询</a>
				</li>
			</ul>
		</div>
		<div id="center-column">
			<iframe id="frame_content" name="center-frame" src="addroute.jsp"
