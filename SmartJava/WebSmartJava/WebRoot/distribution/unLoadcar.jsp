...
<% ArrayList<Car> list=(ArrayList<Car>)session.getAttribute("unLoadcarList"); 
...
<div class="top-bar">
  <h1>卸货管理</h1>
  <div class="breadcrumbs"> <a href="../indexdistribution.jsp" target="_top">首页</a> / <a href="goodsManage.jsp" target="_top">卸货管理</a> </div>
</div>
<div class="top-bar">
  <table class="select-table" id="search" >
    <tr>
      <th>选择卸货车辆：车牌号</th>
      <form name="num" action="actionGoods.jsp?action=uploadUnLoadNumber" method="post">
      ...
      <td><form name="unLoad" action="actionGoods.jsp?action=unLoad" method="post"><input type="button" onclick="unLoad.submit();"  value="卸货"></form></td>
    </tr>
  </table>
</div>
<div class="table" >
