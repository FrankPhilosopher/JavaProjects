...
<body style="background: none">
	<div class="top-bar">
		...
		<div class="breadcrumbs">
			<a href="<%=path%>/indexdistribution.jsp" target="_top">首页</a> / <a
				href="<%=path%><%=path%>/distribution/excelManager.jsp"
				target="_top">报表管理</a>
		</div>
	</div>
				...
				<th colspan="4" style="text-align:left;vertical-align:middle;">
					<div class="selectbar_button_div">
						<input type="button" class="button" width="200"
							onclick="search();" value="查 询" /> <input type="button"
							class="button" width="200" onclick="excel();" value="导 出" />
					</div>
				</th>
			</tr>
		</table>
