	...
	<div id="main">
		...
		<div id="middle">
			<div id="left-column">
				<h3>车辆管理</h3>
				<ul class="nav">
					<li><a href="<%=path%>/distribution/vehicleEnter.jsp"
						target="center-frame">车辆进站及交接单管理</a>
					</li>
					<li><a href="<%=path%>/distribution/listVehicle.jsp"
						target="center-frame">车辆列表</a>
					</li>
				</ul>
			</div>
			<div id="center-column">
				<iframe id="frame_content" name="center-frame"
					src="<%=path%>/distribution/listVehicle.jsp" frameborder="0"
