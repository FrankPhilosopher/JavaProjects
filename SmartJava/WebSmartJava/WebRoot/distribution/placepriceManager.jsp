	...
	<div id="main">
		<div id="header">
			...
			<ul id="top-navigation">
				<li><span><span><a
							href="<%=path%>/indexdistribution.jsp">首页</a>
					</span>
				</span>
				</li>
				...
				<li><span><span><a
							href="<%=path%>/distribution/orderManager.jsp">订单管理</a>
					</span>
				</span>
				</li>
				<li><span><span><a
							href="<%=path%>/distribution/vehicleManage.jsp">车辆管理</a>
					</span>
				</span>
				</li>
				<li><span><span><a
			...
			<%
				if (user.getPriority() == User.DISTRIBUTION_ADMIN) {
					out.print("<div id='operator' class='active'>管理员<span>"
							+ user.getName()
							+ "  登录中     </span>&nbsp;<a href='../login.jsp'>退出</a></div>");
				} else {
					out.print("<div id='operator' class='active'>工作人员<span>"
							+ user.getName()
							+ "  登录中     </span>&nbsp;<a href='../login.jsp'>退出</a></div>");
				}
			%>
		...
		<div id="middle">
			<div id="left-column">
				<h3>配送范围及价格管理</h3>
				<ul class="nav">
					<li><a href="<%=path%>/distribution/placeprice_add.jsp"
						target="center-frame">新增配送范围及价格</a>
					</li>
					<li class="last"><a
						href="<%=path%>/distribution/placeprice_list.jsp"
						target="center-frame">配送范围及价格列表</a>
					</li>
				</ul>
			</div>
			<div id="center-column">
				<iframe id="frame_content" name="center-frame"
					src="<%=path%>/distribution/placeprice_list.jsp" frameborder="0"
