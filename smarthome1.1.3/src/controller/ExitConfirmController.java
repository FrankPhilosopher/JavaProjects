...
public class ExitConfirmController implements Initializable {

	private static ExitConfirmController controller;
	...
	public static ExitConfirmController getInstance() {
		return controller;
	}
	...
	private void initEvents() {
		...
		exitPane.setOnMousePressed(new EventHandler<MouseEvent>() {
		...
		exitPane.setOnMouseDragged(new EventHandler<MouseEvent>() {
			public void handle(MouseEvent me) {
