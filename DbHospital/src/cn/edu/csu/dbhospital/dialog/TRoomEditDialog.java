 ...
 * 
 */
public class TRoomEditDialog extends TitleAreaDialog {
	 ...
	 * @param parentShell
	 */
	public TRoomEditDialog(Shell parentShell, TRoom room) {
		super(parentShell);
	...
	private void initData() {
		if (room != null) {
			txt_name.setText(room.getName());
			txt_info.setText(room.getInfo());
		}
	}
